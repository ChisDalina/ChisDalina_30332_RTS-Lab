...
public  ExecutionThread(Semaphore s9,Semaphore s10,CyclicBarrier bariera, int sleep_min, int sleep_max, int activity_min, int activity_max, int activity_min2, int activity_max2, int permit9, int permit10){
        this.s9=s9;
        this.s10=s10;
